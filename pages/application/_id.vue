              ...
              <div>
                <ul>
                  <li>
                    ...
                    <span>0709 434 000</span>
                  </li>
                  <li>
                    <span>&nbsp;</span>
                    <span>info@momentumcredit.co.ke</span>
                  </li>
                  <li class="mt-4">
                    <span>Customer Care:</span>
                    <span>0709 434 900</span>
                  </li>
                  <li>
                    <span>&nbsp;</span>
                    <span>cx@momentumcredit.co.ke</span>
                  </li>
                </ul>
              </div>
            </div>
...
export default {
  ...
  head() {
    return {
      title: this.pageSource,
      meta: [
        {
          hid: "keywords",
          name: "keywords",
          content: "momentum,sharia,credit,contact,Sahih,branch",
        },
        {
          hid: "title",
          name: "title",
          content: this.pageSource,
        },
        {
          hid: "description",
          name: "description",
  ...
  mounted() {
    ...
    this.pageSource = this.$route.params.id;
  },
  methods: {
    updateMap(town) {
      let self = this;
    ...
    contactFormRequest() {
      ...
      this.form.source = this.pageSource;
