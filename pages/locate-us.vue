          ...
          <div class="form-layout-container">
            ...
            <div class="col-form">
              <form @submit.prevent="contactFormRequest">
                ...
                <div
                  class="input-group md:w-11/12 full"
                  v-if="contactFormSubmitted"
                >
                  <div class="text-sm text-green-700 px-2">
                    Thank you for getting in touch. One of our representative
                    will get in touch with you as soon as possible.
                  </div>
                </div>
                <div class="input-group pt-4 full" v-if="!contactFormSubmitted">
                  <button type="submit" class="btn lg text-white font-bold">
                    Send
                  </button>
                </div>
              </form>
              ...
              <div>
                <div class="info-list">
                  ...
                  <div class="item_">
                    ...
                    <span>
                      <a href="tel:+254709434000 ">+254 709 434 000 </a> or
                      <a href="tel:+254796444555">+254 796 444 555</a>
                  ...
                  <div class="item_">
                    ...
                    <span>
                      <a href="mailto:cx@momentumcredit.co.ke"
                        >info@momentumcredit.co.ke</a
                      >
                    </span>
                  </div>
                </div>
                ...
                <div class="info-list">
                  ...
                  <div class="item_">
                    <img src="/img/icons/ring.svg" alt="Phone Icon" />
                    <span>
                      <a href="tel:+254709434000">+254 709 434 000</a>
                    </span>
                  </div>
                  <div class="item_">
                    <img src="/img/icons/mail.svg" alt="Mail Icon" />
                    <span>
                      <a href="mailto:cx@momentumcredit.co.ke"
                        >cx@momentumcredit.co.ke</a
                      > or                      <a href="mailto:grievance@momentumcredit.co.ke"
                        >grievance@momentumcredit.co.ke</a
                      >
                    </span>
                  </div>
                </div>
                ...
                <div class="info-list">
                  <h5>Office Hours:</h5>
                  <div class="item_">
                    <span class="inline-block mr-2">Mon - Fri:</span>
                    <span>7am to 4pm</span>
                  </div>
                  <div class="item_">
                    <span class="inline-block mr-2">Sat:</span>
                    <span>9am to 12pm</span>
                  </div>
                  <div class="item_">
                    <span class="inline-block mr-2">Sun:</span>
                    <span>Closed</span>
                  </div>
                </div>
              </div>
      ...
      <div class="section-container">
        <div
          :class="{
            ...
            'hide-after': hasScrolledToBottom,
          }"
        >
          <div class="branch-wrapper" @scroll="handleScroll">
            <a href="#" @click.prevent="updateMap('nairobi')">
              <h4>HQ Hairobi</h4>
              <p>
                International House, 11th Floor – Mama Ngina Street Tel: 0796 444
                555
              </p>
              <div>Click to view on map</div>
            </a>
            <a  href="#" @click.prevent="updateMap('Rongai')">
              <h4>Rongai Branch </h4>
              <p>2nd Floor Maasai Mall Magadi Road</p>
              <div>Click to view on map</div>
            </a>
            <a href="#" @click.prevent="updateMap('eldoret')">
              <h4>Eldoret Branch</h4>
              <p>Rupa's Mall, 2nd Floor - Uganda Road.</p>
              <div>Click to view on map</div>
            </a>
            <a href="#" @click.prevent="updateMap('kisii')">
              <h4>Kisii Branch</h4>
              <p>Lengetia Place, 1st Floor - Kisii-Kisumu Main Street</p>
              <div>Click to view on map</div>
            </a>
            <a href="#" @click.prevent="updateMap('kisumu')">
              <h4>Kisumu Branch</h4>
              <p>
                Central Square, 2nd Floor – Oginga Odinga Street, Tel:0748
                726881
              </p>
              <div>Click to view on map</div>
            </a>
            ...
            <a href="#" @click.prevent="updateMap('meru')">
              <h4>Meru Branch</h4>
              <p>Twin Plaza, 3rd Floor - Ghana Street.</p>
              <div>Click to view on map</div>
            </a>
            <a href="#" @click.prevent="updateMap('mombasa')">
              <h4>Mombasa Branch</h4>
              <p>
                Jubilee Insurance Arcade- Ground floor, Moi avenue Tel:
                0757650797
              </p>
              <div>Click to view on map</div>
            </a>
            ...
            <a href="#" @click.prevent="updateMap('thika')">
              <h4>Thika Branch</h4>
              <p>
                T Plaza 4th Floor Kenyatta Highway, Tel: 0742 501
                557
              </p>
              <div>Click to view on map</div>
            </a>
            <a href="#" @click.prevent="updateMap('machakos')">
              <h4>Machakos Branch</h4>
              <p>
               Kiambaa Mall 2nd floor Syokimau Avenue
              </p>
              <div>Click to view on map</div>
            </a>
            <a href="#" @click.prevent="updateMap('embu')">
              <h4>Embu Branch</h4>
              <p>
              Pearl Centre 1st Floor Daya S.N. Patel Road
              </p>
              <div>Click to view on map</div>
            </a>
          </div>
          <div class="map-wrapper" ref="map" id="map">
...
export default {
  name: "ContactPage",
    head: {
    title: "Momentum Credit – Locate Us",
    meta: [
      { charset: "utf-8" },
      ...
      },
      {
        hid: "title",
        name: "title",
        content: "Momentum Credit – Locate Us",
      },
      {
        hid: "description",
        name: "description",
        content: "A Micro-Finance Company in Kenya that provides Working Capital, LPO Financing, Unsecured Low Price Competitive Financing within 24 hours to Individual Entrepreneurs, SMEs and Medium Businesses and help Transforming Africa",
      },
      {
        hid: "og:type",
        property: "og:type",
  ...
  data() {
    return {
      ...
      form: {
        source: "Momentum Get in Touch form",
        name: "",
        phone: "",
        email: "",
        message: "",
  ...
  methods: {
    updateMap(town) {
      ...
      switch (town) {
        ...
        case "eastleigh":
         ...
         case "Rongai":
          self.mapSource =
            "https://www.google.com/maps/embed?pb=!1m18!1m12!1m3!1d3988.6372948763587!2d36.76188761427533!3d-1.3941240361453549!2m3!1f0!2f0!3f0!3m2!1i1024!2i768!4f13.1!3m3!1m2!1s0x182f05e96c3433f7%3A0xb6620ac308ea3b90!2sMaasai%20Mall!5e0!3m2!1sen!2ske!4v1632831900097!5m2!1sen!2ske";
          break;         
        case "mombasa":
          self.mapSource =
        ...
        case "thika":
          ...
          case "machakos":
          self.mapSource =
            "https://www.google.com/maps/embed?pb=!1m18!1m12!1m3!1d719.457883099514!2d37.26870122907831!3d-1.519593181141928!2m3!1f0!2f0!3f0!3m2!1i1024!2i768!4f13.1!3m3!1m2!1s0x182f80ccb7d44a21%3A0xd0891f7a64738ace!2sKiamba%20Mall!5e0!3m2!1sen!2ske!4v1649115138329!5m2!1sen!2ske";
          break;
          case "embu":
          self.mapSource =
            "https://www.google.com/maps/embed?pb=!1m18!1m12!1m3!1d510631.9987926845!2d36.83183695439511!3d-0.9123633972813291!2m3!1f0!2f0!3f0!3m2!1i1024!2i768!4f13.1!3m3!1m2!1s0x18262dc2ea77e4df%3A0xe87592be3dc6541d!2sNaivas%20Pearl%20Centre(Embu)!5e0!3m2!1sen!2ske!4v1649115868154!5m2!1sen!2ske";
          break;
        case "nakuru":
          self.mapSource =
        ...
        case "kisii":
          self.mapSource =
            "https://www.google.com/maps/embed?pb=!1m18!1m12!1m3!1d4303.7644029936555!2d34.76620322642052!3d-0.6710465570500416!2m3!1f0!2f0!3f0!3m2!1i1024!2i768!4f13.1!3m3!1m2!1s0x182b3bf6d1e1ff7d%3A0xe0a531d9e654338d!2sLengetia%20Place%2C%20Kisii!5e0!3m2!1sen!2ske!4v1601380525310!5m2!1sen!2ske";
          break;
        case "meru":
          self.mapSource =
            "https://www.google.com/maps/embed?pb=!1m18!1m12!1m3!1d498.72713098280803!2d37.65514370669175!3d0.04576007010487009!2m3!1f0!2f0!3f0!3m2!1i1024!2i768!4f13.1!3m3!1m2!1s0x178821ea2e259d51%3A0x6c348650e71d12a2!2sTwin%20Plaza%2C%20Meru!5e0!3m2!1sen!2ske!4v1601381622750!5m2!1sen!2ske";
          break;
        case "eldoret":
          self.mapSource =
            "https://www.google.com/maps/embed?pb=!1m18!1m12!1m3!1d3989.657883291051!2d35.288521115310395!3d0.5138245638326783!2m3!1f0!2f0!3f0!3m2!1i1024!2i768!4f13.1!3m3!1m2!1s0x1781019a1fdca337%3A0xcb86afa911fa7bc7!2sRupa%27s%20Mall!5e0!3m2!1sen!2ske!4v1601493498658!5m2!1sen!2ske";
          break;
        default:
          self.mapSource =
            "https://www.google.com/maps/embed?pb=!1m18!1m12!1m3!1d997.2034617316544!2d36.82326204142881!3d-1.2856992952257134!2m3!1f0!2f0!3f0!3m2!1i1024!2i768!4f13.1!3m3!1m2!1s0x182f10d7c9bfe775%3A0xa759dcbd3e197b41!2sMomentum%20credit!5e0!3m2!1sen!2ske!4v1595843647889!5m2!1sen!2ske";
    ...
    async sendDataToServer() {
      ...
      self.$gtm.push({ event: "MomentumGetInTouchFormSubmitted" });
    },
