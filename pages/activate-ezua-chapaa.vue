  ...
  <div class="page-container">
    <section class="page-title-section contact-page p-4">
      ...
      <div class="content titles">
        <h1 class="title">Activate Ezua Chapaa</h1>
      ...
      <div class="content form-layout">
        <div class="form-layout-inner">
          <div class="form-layout-container">
            <h4>
              <span>Activate Ezua Chapaa</span>
            ...
            <div class="col-form">
              <form @submit.prevent="contactFormRequest">
               ...
               <div class="input-group">
                  <label for="l-loanamount">Loan Amount</label>
                  <input
                    type="text"
                    id="l-loanamount"
                ...
                <div class="input-group">
                  <label for="l-message">Vehicle YOM</label>
                  <textarea
          ...
          <div class="form-layout-contacts gray-bg">
            <h4>Not able to register? Call below numbers</h4>
            <div class="col-text">
              <div>
                <div class="info-list">
    ...
    <!-- Map Locator  -->
    <section class="branch-section hidden">
      <div class="section-container">
        <div
          :class="{
        ...
        >
          <div class="branch-wrapper" @scroll="handleScroll">
            ...
            <a href="#" @click.prevent="updateMap('thika')">
              <h4>Thika Branch</h4>
              <p>
                Kigoshi Plaza, Ground Floor – Kenyatta Highway, Tel: 0742 501
                557
              </p>
              <div>Click to view on map</div>
            </a>
